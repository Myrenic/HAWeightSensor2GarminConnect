// Credit: https://github.com/wiecosystem/Bluetooth && https://github.com/lswiderski/WebBodyComposition/
...
class Metrics {
  ...
  getResult = () => {
    const bodyComposition = {
      ...
      proteinPercentage: {
        ...
        value: this.getProteinPercentage(),
      },
      lbmCoefficient: {
        name: "LBM Coefficient",
        value: this.getLBMCoefficient(),
      },
    ...
    const scales = [
      {
        min: 0,
        max: 12,
        female: [12.0, 21.0, 30.0, 34.0],
        male: [7.0, 16.0, 25.0, 30.0],
      },
      {
        min: 12,
        max: 14,
        female: [15.0, 24.0, 33.0, 37.0],
        male: [7.0, 16.0, 25.0, 30.0],
      },
      {
        min: 14,
        max: 16,
        female: [18.0, 27.0, 36.0, 40.0],
        male: [7.0, 16.0, 25.0, 30.0],
      },
      {
        min: 16,
        max: 18,
        female: [20.0, 28.0, 37.0, 41.0],
        male: [7.0, 16.0, 25.0, 30.0],
      },
      {
        min: 18,
        max: 40,
        female: [21.0, 28.0, 35.0, 40.0],
        male: [11.0, 17.0, 22.0, 27.0],
      },
      {
        min: 40,
        max: 60,
        female: [22.0, 29.0, 36.0, 41.0],
        male: [12.0, 18.0, 23.0, 28.0],
      },
      {
        min: 60,
        max: 100,
        female: [23.0, 30.0, 37.0, 42.0],
        male: [14.0, 20.0, 25.0, 30.0],
      },
    ];
  ...
  getMuscleMassScale = () => {
    const scales = [
      {
        min: { male: 170, female: 160 },
        female: [36.5, 42.6],
        male: [49.4, 59.5],
      },
      {
        min: { male: 160, female: 150 },
        female: [32.9, 37.6],
        male: [44.0, 52.5],
      },
